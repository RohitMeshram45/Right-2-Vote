        ...
        <div class="container px-5 py-20 mx-auto flex sm:flex-nowrap flex-wrap ">
          ...
          <div class="lg:w-1/3 md:w-1/2 bg-slate-800 flex flex-col md:ml-auto w-full md:py-5 mt-8 md:mt-0 p-5 rounded-xl">
            ...
            <div class="relative mb-4">
              ...
              <input value={name} onChange={(e) => setName} placeholder='Enter the Name' type="text" id="name" name="name" class="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
            </div>
            <div class="relative mb-4">
              <label for="email" class="leading-7 text-sm text-gray-200 font-bold">Email : </label>
              <input value={email} onChange={(e) => setEmail} placeholder='Enter the Email' type="email" id="email" name="email" class="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
            </div>
            <div class="relative mb-4">
